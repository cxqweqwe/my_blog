  ...
  <div id="login">
    ...
    <div class="loginFrom" v-show="show == 1">
      ...
      <div class="foot">
        ...
        <div class="foot-text">
          <div class="foot-text-left" @click="show = 2">
            没有账号？去注册
          </div>
    ...
    <div class="register" v-show="show == 2">
      <div class="head">
        欢迎新用户注册
      </div>
      <div class="body">
        ...
        <div class="captcha">
          <div class="captcha-left">
            <el-input
                placeholder="请输入验证码"
                v-model="register.emailCaptcha"
                prefix-icon="el-icon-s-grid">
            </el-input>
          </div>
          <div class="captcha-right">
            <el-button type="primary" size="medium" @click="getEmailCaptcha">获取验证码</el-button>
          </div>
        </div>
        <br/><br/>
        <div class="space"></div>
      ...
      <div class="foot">
        <el-button type="primary" size="medium" @click="sendRegister">注册</el-button>
        <div class="foot-text">
    ...
    <div class="forgetPassword" v-show="show == 3">
      <div class="head">
        修改密码
      </div>
      <!--      <div class="body">-->
