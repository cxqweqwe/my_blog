                ...
                <TabPane label="个人信息" icon="ios-person" name="personalInfo">
                  ...
                  <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="130">
                    ...
                    <FormItem label="简介" prop="personalProfile">
                      <Input v-model="formValidate.personalProfile" type="textarea" :autosize="{minRows: 2,maxRows: 5}"
                             :border="false" :clearable="true" placeholder="Enter something about you..."></Input>
                    </FormItem>
                    ...
                    <FormItem label="毕业学校" prop="school">
                      <Input v-model="formValidate.school" placeholder="Enter your university" :border="false" :clearable="true"></Input>
                    </FormItem>
                    <FormItem label="专业" prop="major">
                      <Input v-model="formValidate.major" placeholder="Enter your college major" :border="false" :clearable="true"></Input>
                    </FormItem>
                    <FormItem label="入学时间" prop="admissionTime">
                      <FormItem prop="date">
                        <DatePicker type="date" placeholder="Select date" v-model="formValidate.admissionTime" :format="'yyyy-MM-dd'"></DatePicker>
                      </FormItem>
                    </FormItem>
                    <FormItem label="所在公司" prop="companyName">
                      <Input v-model="formValidate.companyName" placeholder="Enter your company name" :border="false" :clearable="true"></Input>
                    </FormItem>
                    <FormItem label="职位" prop="positionName">
                      <Input v-model="formValidate.positionName" placeholder="Enter your position name" :border="false" :clearable="true"></Input>
                    </FormItem>
                    <FormItem label="行业" prop="industry">
                      <Input v-model="formValidate.industry" placeholder="Enter your industry" :border="false" :clearable="true"></Input>
                    </FormItem>
                    <FormItem label="开始工作日期" prop="workDate">
                      <FormItem prop="workDate">
                        <DatePicker type="date" placeholder="Select date" v-model="formValidate.workDate" :format="'yyyy-MM-dd'"></DatePicker>
                      </FormItem>
                    </FormItem>

                    <FormItem label="手机号" prop="name">
                      <Input v-model="formValidate.name" placeholder="Enter your realName" :border="false" :readonly="true"></Input>
                    </FormItem>
                    <FormItem label="邮箱" prop="mail">
                      <Input v-model="formValidate.mail" placeholder="Enter your e-mail" :border="false" :readonly="true"></Input>
                    </FormItem>
...
<script>
  ...
  import {getAuthorInfo,updateUserInfo} from "network/userInfo";
