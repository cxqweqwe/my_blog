	...
	<div class="col-sm-6">
		...
		<div class="post">
			<div class="thumb rounded">
				...
				<a href="blog-single.html">
					<div class="inner">
						<img src="~assets/img/posts/trending-lg-1.jpg" alt="post-title" />
					</div>
				</a>
			</div>
			<ul class="meta list-inline mt-4 mb-0">
				<li class="list-inline-item"><a href="#"><img src="~assets/img/other/author-sm.png" class="author" alt="author"/>Katen Doe</a></li>
		...
		<div class="post post-list-sm square before-seperator">
			<div class="thumb rounded">
				<a href="blog-single.html">
					<div class="inner">
						<img src="~assets/img/posts/trending-sm-1.jpg" alt="post-title" />
					</div>
				</a>
			</div>
		...
		<div class="post post-list-sm square before-seperator">
			<div class="thumb rounded">
				<a href="blog-single.html">
					<div class="inner">
						<img src="~assets/img/posts/trending-sm-2.jpg" alt="post-title" />
					</div>
				</a>
			</div>
			<div class="details clearfix">
